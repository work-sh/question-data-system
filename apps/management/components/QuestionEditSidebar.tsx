...
import { Eye, GripVertical, Plus, Share, X } from "lucide-react";
...
export function QuestionEditSidebar({ className }: QuestionEditSidebarProps) {
  ...
  return (
    <div
      className={`w-[290px] bg-white border-l border-gray-200 flex flex-col ${className}`}
    >
      {/* Action Buttons */}
          ...
          <div className="flex-1 p-5">
            <TabsContent value="edit" className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-3">
                  <Label htmlFor="difficulty" className="text-xs text-gray-600">
                    난이도
                  </Label>
