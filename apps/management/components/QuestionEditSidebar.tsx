...
export function QuestionEditSidebar({
  className,
  isCollapsed = false,
}: QuestionEditSidebarProps) {
  ...
  return (
    <div
      className={`h-svh overflow-hidden flex transition-all duration-300 ${isCollapsed ? "w-0" : "w-[290px]"} ${className}`}
    >
      {/* 사이드바 내용 */}
      {!isCollapsed && (
        <div className="m-4 ml-0 w-full bg-background border border-gray-200 rounded-xl shadow-sm flex flex-col">
          {/* Tab Menu */}
          <Tabs defaultValue="edit" className="w-full h-full">
            <TabsList className="m-2 w-[100%-16px]">
            ...
            {/* Content */}
            <div className="p-4 flex min-h-0 flex-1 flex-col gap-2 overflow-auto">
              <TabsContent value="edit" className="space-y-6">
                ...
                <div>
                  ...
                  <RadioGroup value={layout} onValueChange={setLayout}>
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="layout-vertical" className="text-sm">
                        위아래로
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="layout-horizontal" className="text-sm">
                        좌우로
                      </Label>
                    </div>
                  </RadioGroup>
                          ...
                          <div className="flex w-full max-w-sm items-center gap-2">
                            ...
                            <InputGroup>
                              ...
                              <InputGroupAddon align="inline-end">
                                <InputGroupText>
                                  {option.charCount}/{MAX_CHAR_COUNT}
                                </InputGroupText>
                              </InputGroupAddon>
                            </InputGroup>
                            <Button
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <Label htmlFor="textbook" className="text-xs text-gray-600">
                      교과서
                    </Label>
